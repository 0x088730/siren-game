...
const CreatePart = (props) => {
    ...
    return (
        <div className='flex-mid flex-col h-full'>
            ...
            <div className="text-[#ffff19] text-[14px] font-[400] flex-mid items-end mt-2">GUILD BONUS<span className='text-[11px]'>(all members)</span>: <span className='text-white'> +10% CSC EARN</span></div>
